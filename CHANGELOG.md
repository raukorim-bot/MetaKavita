...
> **Hotfix (same 1.6.1 line):** BF52 + library denylist = auto-sync only + account password change + Manual Review list/bulk-accept + Kavita verification link + batch performance/accuracy fixes. No version bump.
