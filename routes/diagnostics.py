...
from services.scraper_diagnostics import probe_all, probe_scraper, run_preflight
...
def probe_all_route():
    ...
    scrapers = list(ScraperRegistry.get_all())
    total = len(scrapers)
    ...
    def generate():
        ...
        yield json.dumps({"type": "done", "total": total}, ensure_ascii=False) + "\n"
