const FR = {
  ...
  fabOpenMeta: "Ouvrir dans MetaKavita",
  fabConfig: "Config",
  ...
  configShowFabs: "Afficher les boutons d’action",
  ...
  configModeSimple: "Simplifiée",
  configModeExpert: "Experte",
  configLang: "Langue",
  ...
  optionsUsePopupForSite: "Pour activer un site Kavita, ouvrez le Companion depuis l’icône de la barre d’outils, sur l’onglet Kavita concerné.",
  ...
  toastTestOkVersion: "Connexion OK — MetaKavita $1$",
  ...
  confirmAutoBody: "Les métadonnées de cette série vont être remplacées par ce que MetaKavita trouve, sans que vous les voyiez d’abord. Continuer ?",
...
const EN = {
  ...
  fabAuto: "Auto",
  fabCover: "Cover",
  fabWorkshop: "Volume Workshop",
  fabCompleteSeries: "Complete this series",
  fabCompleteAuto: "Complete without asking me",
  fabChangeCover: "Change the cover",
  fabOpenMeta: "Open in MetaKavita",
  fabConfig: "Config",
  fabBmc: "Buy me a coffee",
  fabLogo: "Open MetaKavita menu",
  badgeDone: "up to date",
  badgeWorking: "being processed",
  badgePending: "waiting to be enriched",
  badgeIgnored: "ignored",
  badgeUnknown: "unknown to MetaKavita",
  configTitle: "Companion settings",
  configMetaUrl: "MetaKavita URL",
  configToken: "Webhook token",
  configShowFabs: "Show the action buttons",
  coverTitle: "Pick a cover",
  coverSearch: "Search",
  coverSearching: "Searching covers…",
  coverEmpty: "No covers found",
  coverCount: "$1$ cover(s)",
  ...
  configMode: "Interface",
  configModeSimple: "Simplified",
  configModeExpert: "Expert",
  configLang: "Language",
  ...
  optionsUsePopupForSite: "To enable a Kavita site, open Companion from the toolbar icon while that Kavita tab is in front.",
  ...
  toastTestOkVersion: "Connection OK — MetaKavita $1$",
  ...
  confirmAutoBody: "This series' metadata will be replaced with whatever MetaKavita finds, without showing it to you first. Continue?",
  confirmAutoSeeFirst: "See it before writing",
  confirmGo: "Continue",
